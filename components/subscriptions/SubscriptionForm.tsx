...
export function SubscriptionForm({
  ...
  async function handleSubmit(formData: FormData) {
    ...
    const values: SubscriptionFormValues = {
      ...
      manage_url: String(formData.get("manage_url") ?? ""),
      cancel_url: String(formData.get("cancel_url") ?? ""),
    };
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              name="manage_url"
              type="url"
              defaultValue={defaultValues?.manage_url}
              placeholder="https://…"
            />
          </div>
          <div>
            ...
            <Input
              ...
              name="cancel_url"
              type="url"
              defaultValue={defaultValues?.cancel_url}
              placeholder="https://…"
            />
          </div>
        </div>
